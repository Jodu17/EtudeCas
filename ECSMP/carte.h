...
enum {CHEMIN,HERBE,EAU,MUR,ARBRE};
SDL_Surface *ecran,*sprites,*perso,*gland;
SDL_Rect positionChemin,positionHerbe,positionEau,positionMur,positionArbre,PosFinal,positionPerso,posPerso,positionObjet;
